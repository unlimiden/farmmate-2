  ...
  return (
    <div className="w-full bg-[#f8fbef] min-h-screen px-4 sm:px-6 lg:px-8 py-6 sm:py-12 font-sans max-w-7xl mx-auto space-y-8 sm:space-y-12">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-2 sm:space-y-3">
        <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-gray-900">{t.about} Farm Mate</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
        <div className="lg:col-span-6 space-y-4 sm:space-y-6">
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Protecting Harvests Through Advanced Neural Networks</h2>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-1 sm:pt-2">
            <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-[#e2ebd4] space-y-1">
              <h3 className="text-xl sm:text-2xl font-extrabold text-[#14532d]">50+</h3>
              <p className="text-[11px] sm:text-xs text-gray-500 font-medium">Major Crop Species Supported</p>
            </div>
            <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-[#e2ebd4] space-y-1">
              <h3 className="text-xl sm:text-2xl font-extrabold text-[#14532d]">98.4%</h3>
              <p className="text-[11px] sm:text-xs text-gray-500 font-medium">Diagnostic Accuracy Rate</p>
            </div>
          </div>
        </div>
